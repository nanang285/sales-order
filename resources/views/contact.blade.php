...
@include('layouts.navbar')
    ...
    <div class="relative">
        <div id="about" class="bg-fixed bg-cover bg-no-repeat"
            style="background-image: url('{{ asset('dist/images/homepages/zmi-bg-contact.jpg') }}')">
            <div class="relative max-h-screen py-32 lg:py-56 bg-gray-900 bg-opacity-85">
                <div class="mx-auto max-w-4xl">
                    <div class="flex justify-center">
                        <div class="mx-4 relative rounded-full px-3 mt-12 lg:mt-0 text-sm leading-6 text-gray-600">
            ...
            <div class="container mx-auto px-6 lg:px-8 relative">
                ...
                <div class="flex mb-10 flex-col md:flex-row">
                    <div data-aos="fade-up" data-aos-anchor-placement="top-center" class="md:w-1/2 p-6">
                        <h2 class="lg:text-3xl text-xl text-primary font-bold mb-4">Temukan Dan Berhubungan Dengan Kami
                            Disini</h2>
                        <p class="text-base text-primary font-bold">
                            Telepon
                        </p>
                        <p class="text-base mb-4 text-primary font-normal">
                            <a href="https://api.whatsapp.com/send?phone={{ $footerSection->no_telp }}&text=Hallo%20Zen%20Multimedia%20Indonesia%2C%20"
                                class="text-sm transition duration-400" target="_blank">{{ $footerSection->no_telp }}</a>
                        </p>
                        <p class="text-base text-primary font-bold">
                            Email
                        </p>
                        ...
                        <p class="text-base space-x-2 flex text-primary font-bold">
                            ...
                            <a class="text-xl hover:text-blue-800 transition duration-400" target="_blank"
                                ...
                                class="text-sm transition duration-400" target="_blank"">
                    ...
                    <div data-aos="fade-up" data-aos-anchor-placement="top-center"
                        class="mt-8 md:w-1/2 bg-fixed rounded bg-cover bg-no-repeat"
                        style="background-image: url('{{ asset('dist/images/homepages/zmi-contact-images.png') }}')">
                        <div class="relative rounded-lg bg-[#000000b3] w-full flex justify-center items-center">
                            <div class="relative max-h-auto w-full my-12 mx-6">
                                <div class="mx-auto max-w-full lg:text-center mb-10">
                                    ...
                                    <p
                                        class="mt-4 max-w-md text-base font-bold tracking-tight text-gray-900 text-center mx-auto">
                                        <span class="text-gray-200">Isi formulir dan tim kami akan menghubungi Anda kembali
                                            dalam waktu 24 jam,</span>
                                    </p>
                                </div>
                                <form method="POST" action="{{ route('login') }}" class="mx-auto max-w-md">
                                    ...
                                    <div class="mb-3">
                                        <div class="relative">
                                            <label for="email" class="block text-sm font-medium text-white mb-2">Nama
                                                Lengkap</label>
                                        </div>
                                        <div class="relative">
                                            <div
                                    ...
                                    <div class="mb-3">
                                        <div class="relative">
                                            <label for="email" class="block text-sm font-medium text-white mb-2">No
                                                Telp</label>
                                        </div>
                                        <div class="relative">
                                            <div
                                    ...
                                    <div class="mb-3">
                                        <div class="relative">
                                            <label for="email" class="block text-sm font-medium text-white mb-2">Isi
                                                Pesan</label>
                                        </div>
                                        <div class="relative">
