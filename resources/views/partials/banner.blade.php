<div id="bottom-banner" tabindex="-1"
    ...
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm lg:text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <span class="text-center">"Tunggu apa lagi? Ayo Bangun Website Anda & Jadilah Mitra Kami!" <a
                    href="#"
                    class="text-blue-600 md:ms-1 dark:text-blue-500 hover:underline">Bangun Sekarang <i
                        class="text-blue-600 text-sm fa-solid fa-arrow-right"></i>
