                                    ...
                                    <div class="grid grid-cols-5 gap-2 lg:gap-3">
                                        <div class=" rounded col-span-5 lg:col-span-5 flex flex-col relative">
                                            <div class="w-full max-w-full">
                                              <img src="{{asset('dist/images/event-zmi-2.png')}}" class="rounded-lg">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-5 gap-2 lg:gap-3 my-4">
                                        <div class=" rounded col-span-5 lg:col-span-5 flex flex-col relative">
                                            <div class="w-full max-w-full">
