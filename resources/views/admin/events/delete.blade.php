            ...
            <div class="bg-white shadow-sm my-6 border rounded-lg p-6">
                ...
                <div class="flex flex-col">
                    <div class="min-w-full">
                        <form action="{{ route('admin.events.delete', $event->slug) }}" method="post" id="eventForm" enctype="multipart/form-data">
                            @csrf
                            @method('DELETE')
                                                ...
                                                <div class="w-full border border-gray-200 rounded-lg bg-gray-50">
                                                    <div class="px-3 py-2 border-b">
                                                        ...
                                                        <button type="submit" id="updateButton"
                                                                class="my-1 ring-2 font-semibold ring-red-500 text-red-500 hover:text-white hover:bg-red-500 text-sm py-1.5 px-2.5 rounded transition duration-300">
                                                            Hapus
                                                        </button>
                                                    </div>
                                                </div>
