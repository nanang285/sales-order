                ...
                <form class="space-y-4" action="{{ route('service.store') }}" method="POST"
                    ...
                    <div>
                        ...
                        <textarea name="subtitle" id="subtitle_{{ $service->id ??'' }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-24 max-h-28 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400"
                            placeholder="Masukan Informasi" required>{{ $service->subtitle ?? '' }}</textarea>
                    </div>
                    <div>
                        <label for="images"
                    ...
                    <button type="submit"
                        class="w-full text-white bg-green-700 hover:bg-green-800 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Tambah
                        Data</button>
                </form>
            </div>
        </div>
            ...
            <div class="relative bg-white rounded-lg shadow p-4">
                ...
                <div class="">
                    <form class="space-y-4" action="{{ route('service.update', $service->id) }}" method="POST"
                        ...
                        <div>
                            <label for="image_{{ $service->id }}" class="block mb-2 text-sm font-medium text-gray-900">Gambar</label>
                            <div class="flex items-center justify-center w-full">
                                <label for="image_{{ $service->id }}"
                                    ...
                                    <input id="image_{{ $service->id }}" type="file" name="image_path" class="hidden" />
                                </label>
                            </div>
                        </div>
                        <button type="submit"
