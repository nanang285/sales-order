            ...
            <div class="bg-white shadow-lg grid grid-cols-10 gap-3 lg:gap-4 my-4">
                <div class="p-5 rounded col-span-10 lg:col-span-4">
                    <div class="mb-3">
                        ...
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->name }}">
                        </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">Email :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->email }}">
                    </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">NIK :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" placeholder="-" value="{{ $recruitment->nik }}">
                        </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">Alamat :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->address }}">
                        </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">No.Telp/HP/WA :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->phone_number }}">
                    </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">Pendidikan :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->study }}">
                        </input>
                    </div>
                   <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">Posisi Yang Dilamar :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->position }}">
                        </input>
                    </div>
                    <div class="mb-3">
                        <label for="title" class="block mb-1 text-base font-medium text-gray-900">Gaji Yang Diharapkan :</label>
                        <input class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded w-full p-2" value="{{ $recruitment->salary }}">
                        </input>
                    </div>
                </div>
                        ...
                        <li class="flex flex-col mb-10 ms-10 {{ $recruitment->stage2 ? 'text-green-600' : ($recruitment->failed_stage === 'Test Project' ? 'text-red-600' : 'text-gray-500') }}">
                            ...
                            @if ($recruitment->stage1 && !$recruitment->stage2 && !$recruitment->failed_stage)
                                <form action="{{ route('recruitment.updateStage', [$recruitment->uuid, 'stage2']) }}" method="POST">
                                    @csrf
                                    <button name="action" value="yes" class="bg-blue-500 text-white text-sm px-2.5 py-0.5 rounded hidden">Iya</button>
                                    <button name="action" value="no" class="bg-red-500 text-white text-sm px-2.5 py-0.5 rounded hidden">Tidak</button>
                                </form>
                            @endif
                        </li>
