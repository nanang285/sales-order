            ...
            <div class="grid grid-cols-10 gap-4">
                <div class="bg-white shadow-lg p-5 my-6 border rounded col-span-10">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="my-3">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Email<span class="text-red-600 text-base">*</span></label>
                        ...
                        <div class="my-3">
                            <label for="no_telp" class="block mb-2 text-sm font-medium text-gray-900">No.Hp/Wa<span class="text-red-600 text-base">*</span></label>
                            <input type="number" name="phone_number" id="no_telp"
                                class="bottom-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400"
                                placeholder="628**********" required value="" />
                        </div>

                        <div class="my-3">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nama Lengkap<span class="text-red-600 text-base">*</span></label>
                        ...
                        <div class="my-3">
                            <label for="nik" class="block mb-2 text-sm font-medium text-gray-900">NIK/Nomor Induk Penduduk</label>
                        ...
                        <div class="my-3">
                            <label for="address" class="block mb-2 text-sm font-medium text-gray-900">Alamat<span class="text-red-600 text-base">*</span></label>
                    ...
                    <div class="grid grid-col-4">
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <input id="dropzone-file" name="file_path" type="file" class="hidden" accept="application/pdf" />
                            </label>
                        </div>
                    </div>
