        ...
        <div class="px-4 pt-6">
            ...
            <form method="POST" action="{{ route('promo.update', $promoSection->id) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-10 gap-3 lg:gap-4">
                    <div
                        class="bg-white shadow-lg p-5 lg:my-6 border-lg rounded col-span-10 lg:col-span-4 flex flex-col items-center">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute top-0 right-0 mt-2 mr-2">
                                <label for="images"
                                    class="bg-white text-gray-800 hover:bg-blue-700 hover:text-white rounded-full p-2 shadow-lg cursor-pointer flex justify-center items-center transition duration-300">
