...
@section('container')
    <div class="relative mt-3">
        <div class="px-4 pt-6">
            ...
            <div class="max-w-full w-full bg-white rounded-lg shadow p-4 my-6 md:p-6">
                    ...
                    <div class="flex-col items-center">
                        <div class="flex items-center mb-1">
                            ...
                            <div data-popover id="chart-info" role="tooltip"
                                class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:border-gray-600 dark:text-gray-400">
            ...
            <script>
                const getChartOptions = () => {
                    return {
                        ...
                        labels: ["Project Manager", "Frontend Developer", "Backend Developer", "UI/UX Developer",
                            "Fullstack Developer", "Mobile Developer", "DevOps Developer",
                            "Quality Assurance", "Quality Control", "Accounting Staff / Tax Staff",
                        ],
                        dataLabels: {
                            enabled: true,
                            style: {
