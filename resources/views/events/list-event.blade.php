            ...
            <div class="container mx-auto px-6 lg:px-8 relative">
                <div class="mx-auto max-w-full lg:text-left mb-12 flex justify-between items-center">
                    ...
                    {{-- <div class="relative group">
                        ...
                        <div id="dropdown"
                            class="z-50 hidden bg-white divide-y border border-gray-400 divide-gray-100 rounded-lg shadow w-44">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                aria-labelledby="dropdownDefaultButton">
                                @foreach ($events as $event)
                                    <li>
                                        <a href="#"
                                            class="block px-4 py-2 hover:bg-gray-100">{{ $event->kategori }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    @foreach ($events as $event)
                        <div data-aos="fade-up" data-aos-anchor-placement="top-center"
                            ...
                            <div
                                ...
                                <button data-modal-target="static-modal_{{ $event->slug }}"
                                    data-modal-toggle="static-modal_{{ $event->slug }}"
                            ...
                            <div class="px-4 py-4 flex-grow flex flex-col">
                                ...
                                <p class="text-blue-700 text-sm font-semibold">
                                    {{ \Carbon\Carbon::parse($event->waktu)->translatedFormat('l, d F Y H:i') }}
                                </p>
