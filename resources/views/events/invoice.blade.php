                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-10">
                    ...
                    @if ($ticketData)
                        <div class="flex items-center justify-center bg-gray-100">
                            <div class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow border" id="invoice">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="border-gray-200 ">
                                                ...
                                                <td
                                                    class="py-5 pl-3 pr-4 text-right text-base font-bold text-gray-500 sm:pr-0">
                                                    Rp
                                                    {{ number_format($ticketData['harga'], 0, ',', '.') }}</td>
                                            </tr>

                                            <tr>
                                                <td class="pl-3 pr-3 pt-4 text-left text-base font-bold text-gray-900">Total
                                                </td>
                                                <td
                                ...
                                <div class="pt-4 text-base font-semibold text-gray-500 text-center">
                                    Cek email untuk detail transaksi atau Klik <span class="text-green-500">Dapatkan
                                        Tiket</span> Anda.
                                </div>

                                <div class=" mt-8 flex justify-center">
                                    <a href="{{ route('event.ticket', ['kode' => $kode]) }}"
                                        class="bg-green-500 hover:bg-green-700 text-base text-white font-bold py-1.5 px-3 rounded-lg">
                                        Dapatkan Tiket
                                    </a>
                                </div>
