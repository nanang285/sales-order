    ...
    @if ($ticketData)
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow border my-6" id="invoice">
                ...
                <div class="border-t-2 pt-4 text-base font-semibold text-gray-500 text-center">
                    Cek email untuk detail transaksi atau Klik <span class="text-green-500">Dapatkan Tiket</span> Anda.
                </div>

                <div class="my-8 flex justify-center">
                    <a href="{{ route('event.ticket', ['kode' => $kode]) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg">
                        Dapatkan Tiket
                    </a>
                </div>
                ...
                <div class="border-t-2 text-sm font-semibold text-red-500 text-center">
