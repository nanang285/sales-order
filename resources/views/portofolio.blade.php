        ...
        <div class="relative max-h-screen py-28 lg:py-52 bg-gray-900 bg-opacity-90">
            <div class="mx-auto max-w-4xl">
                <div class="flex justify-center">
                    <div
                        class="mx-4 relative rounded-full px-3 mt-4 py-1 text-sm leading-6">
                        ...
                        <p class="mt-6 text-lg lg:text-xl leading-8 text-center text-gray-200">
                            Kami di PT Zen Multimedia telah mengerjakan berbagai proyek yang mencakup pembuatan website, aplikasi, dan multimedia. Berikut beberapa proyek yang telah kami kerjakan:
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:grid-cols-3">
                @foreach ($latestProject as $project)
                    <div data-aos="fade-up" data-aos-anchor-placement="top-center" class="relative max-w-full rounded-xl bg-white overflow-hidden shadow-lg z-40 group">
                        ...
                        <div class="absolute bg-white rounded-r-md top-6 left-0 p-2">
                            <img src="{{ asset('images/zen-logo.png') }}" class="max-w-10 mx-2 max-h-6">
                        </div>
                        <div class="px-4 py-4">
                            <div class="font-bold text-xl mb-2 hover:text-primary transition duration-300">
                                <a target="_blank" href="{{ $project->button_link }}">{{ $project->title }} <span class="text-sm"><i class="fa-solid fa-arrow-up-right-from-square"></i></span> </a>
                            </div>
